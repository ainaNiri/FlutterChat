                            ...
                            text: TextSpan(
                              ...
                              children: <TextSpan>[
                                ...
                                TextSpan(
                                  ...
                                  style: TextStyle(fontWeight: FontWeight.w400, fontSize: 35,fontStyle: FontStyle.italic)
                                )
                              ]
                            ),
                          ),
                          Text("Upload your photo here to share it with your friends", style: TextStyle(fontWeight: FontWeight.w300, fontSize: 14),)
                        ] ,
                      ),
        ...
        children: [
          ...
          ElevatedButton(
            onPressed: ()async {
              ...
              await FirebaseDatabase.instance.reference().child("images").child(currentUser.id).child(this.imageCollection).set({urlPic: true});
